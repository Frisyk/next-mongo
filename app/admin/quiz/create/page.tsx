            ...
            <div className="mb-6">
              <div className="mb-4">
                ...
                <input
                  type="text"
                  name="tag"
                  className="w-full p-2 border bg-slate-50 dark:bg-slate-800 rounded-lg"
              ...
              <div className="mb-4">
                <label className="block  text-sm font-bold mb-2">Option A</label>
                  <div className="mb-2">
                    <input
                      type="text"
                      name="option-a"
              ...
              <div className="mb-4">
                <label className="block  text-sm font-bold mb-2">Option B</label>
                  <div className="mb-2">
                    <input
                      type="text"
                      name="option-b"
              ...
              <div className="mb-4">
                <label className="block  text-sm font-bold mb-2">Option C</label>
                  <div className="mb-2">
                    <input
                      type="text"
                      name="option-c"
              ...
              <div className="mb-4">
                <label className="block  text-sm font-bold mb-2">Option D</label>
                  <div className="mb-2">
                    <input
                      type="text"
                      name="option-d"
